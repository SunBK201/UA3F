...
ua3f = Map("ua3f",
    "UA3F",
    [[
        <a href="https://github.com/SunBK201/UA3F" target="_blank">Version: 0.9.0</a>
        <br>
...
uaRegexPattern.placeholder = "(Apple|iPhone|iPad|Mac|Macintosh|Mac OS X|Microsoft|Windows|Linux|Android|Mobile)"
